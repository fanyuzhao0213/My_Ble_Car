...
uint32_t Motor1_Number_Of_Pulses = 0;
uint32_t Motor2_Number_Of_Pulses = 0;
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_1, 1000);    //修改比较值，修改占空比
	__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_2, 0);    //修改比较值，修改占空比
	__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_3, 0);    //修改比较值，修改占空比
	__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_4, 0);    //修改比较值，修改占空比
//	HAL_Delay(1000);
//	__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_1, 0);    //修改比较值，修改占空比+
//	__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_1, 300);    //修改比较值，修改占空比
//	HAL_Delay(3000);
//	__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_1, 800);    //修改比较值，修改占空比
//	HAL_Delay(3000);
//	__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_1, 0);    //修改比较值，修改占空比+
//	HAL_Delay(1000);
